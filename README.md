...
> 
>    List of allowed intellix trusts for autostore task. A source document will be only be stored if `Document.IntellixTrust` property is included. If omitted only "Green" is allowed by default.
> 
