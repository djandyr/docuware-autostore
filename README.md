...
> 
>    List of allowed intellix trusts for autostore task. A source document will be only be stored if `Document.IntellixTrust` property is included in allowed intellix trust configuration. If not configured only "Green" is allowed by default.
> 
