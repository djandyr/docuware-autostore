...
* __autoStore.restrictSuggestions__
  ...
  If this flag is true, only intellix suggestion fields named in configuration will be used to populate source document index. If false, all intellix suggestions will be returned. Default:  `true`
